...
//		testListaVinosXPais();
//		testDiccPaisConjUvasPais();
//      testcalcularNumeroVinosPais2();
//		testobtenerVinoMejorPuntuado2();
//		testobtenerVinosRangoPuntos2();
	}
...
//	private static void testListaVinosXPais() {
//	    System.out.println("\nTEST de Lista Vinos por Pais");
//	    try {
//	        System.out.println("  UVAS POR PAIS: " + vinos.getListaVinosXPais());
//	    } catch(Exception e) {
//	        System.out.println("Excepción capturada:\n   " + e);
//	    }
//	}
//	
//
//	private static void testDiccPaisConjUvasPais() {
//		System.out.println("\nTEST de Diccionario Pais-Uva");
//		System.out.println(vinos.getDiccPaisConjUvasPais());
//    }
	
	
//	  private static void testcalcularNumeroVinosPais2() {
//        System.out.println("Número de vinos para un país: " + vinos.calcularNumeroVinosPais2("Spain"));
//    }
	
	
//	private static void testobtenerVinoMejorPuntuado2() {
//        System.out.println("Vino mejor puntuado: " + vinos.obtenerVinoMejorPuntuado2());
//    }
//	
	
//  private static void testobtenerVinosRangoPuntos2() {
//  System.out.println("Vino entre rangos: " + vinos.obtenerVinosRangoPuntos2(90, 94));
//}
